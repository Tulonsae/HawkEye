...
public class SearchParser {
    ...
    public void parseLocations() {
        ...
        if (radius != null) {
            ...
            //Format min and max
            minLoc = new Vector(loc.getBlockX() - radius, loc.getBlockY() - radius, loc.getBlockZ() - radius);
            maxLoc = new Vector(loc.getBlockX() + radius, loc.getBlockY() + radius, loc.getBlockZ() + radius);
