 ...
 * Deletes data older than date specified in config, if cleanse is true.
...
public class CleanseUtil extends TimerTask {
    ...
    /**
     * Initiates utility.
     * Simply returns if the age or period is invalid.  (This was originally
     * used to disabling cleansing.  Use the cleanse flag now.)
     * Throws exception for any other errors while processing the config time
     * value.
     * @throws Exception
     */
